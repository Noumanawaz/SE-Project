    ...
    const handleCreateUser = async (e) => {
        ...
        reader.onloadend = async () => {
            ...
            const feeDetails = {
                ...newUser,
                status: 'pending',
                latestFees: base64Image, // Store the Base64 string
            };

            try {
                const userEmail = localStorage.getItem('userEmail');
                await addFeeDetail.mutate({ newFeeDetail: feeDetails, email: userEmail }, {
                    onSuccess: () => {
    ...
    return (
        <>
            {isLoading ? (
                ...
                <>
                    <Button onClick={() => setCreateFormOpen(true)}>Create fee</Button>
