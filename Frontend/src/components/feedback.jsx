...
const FeedbackForm = () => {
  ...
  return (
    <div className="max-w-md mx-auto my-10 p-6 bg-white border rounded-xl shadow-lg">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <button
          ...
          className={`w-full px-6 py-3 text-white font-medium rounded-lg shadow-sm transition-all duration-200 
            ${
              status.submitting
