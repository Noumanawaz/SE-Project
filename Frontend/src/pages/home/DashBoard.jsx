  ...
  return (
    <>
      <main className="font-sans bg-white">
        ...
        {/* Add a modern call-to-action section */}
        <div className="bg-blue-600 py-16">
          <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
            ...
            <Link 
              to="/signup" 
              className="inline-block px-8 py-4 text-lg font-bold text-blue-600 bg-white rounded-full transition-all hover:bg-gray-100 hover:shadow-lg"
            >
              Join Now
            </Link>
          </div>
